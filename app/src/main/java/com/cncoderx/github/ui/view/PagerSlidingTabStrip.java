...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private @LayoutRes int tabLayoutResId = View.NO_ID;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabLayoutResId = a.getResourceId(R.styleable.PagerSlidingTabStrip_pstsTabLayout, tabLayoutResId);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            int iconRes = View.NO_ID;
            CharSequence title = adapter.getPageTitle(i);
            if (adapter instanceof PagerSlidingTabStrip.IconTabProvider) {
                iconRes = ((PagerSlidingTabStrip.IconTabProvider) adapter).getPageIconResId(i);
            }
            if (tabLayoutResId == View.NO_ID) {
                if (iconRes != View.NO_ID) {
                    addIconTab(i, tabLayoutResId);
                } else {
                    addTextTab(i, title.toString());
                }
            } else {
                View v = LayoutInflater.from(getContext()).inflate(tabLayoutResId, null);
    ...
    public @LayoutRes int getTabLayoutResId() {
        return tabLayoutResId;
    }

    public void setTabLayoutResId(@LayoutRes int tabLayoutResId) {
        this.tabLayoutResId = tabLayoutResId;
    }
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<PagerSlidingTabStrip.SavedState> CREATOR = new Parcelable.Creator<PagerSlidingTabStrip.SavedState>() {
            @Override
