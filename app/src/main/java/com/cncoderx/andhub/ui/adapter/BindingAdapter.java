package com.cncoderx.andhub.ui.adapter;
 ...
 * @author cncoderx
 */
public class BindingAdapter<T> extends RecyclerView.Adapter<BindingAdapter.ViewHolder>
        implements IArray<T>, IArray.Callback {
    ...
    public BindingAdapter(@LayoutRes int resource, int variableId) {
        mResource = resource;
    ...
    @SafeVarargs
    public BindingAdapter(@LayoutRes int resource, int variableId, @NonNull T... objects) {
        mResource = resource;
        mVariableId = variableId;
    ...
    public BindingAdapter(@LayoutRes int resource, int variableId, @NonNull Collection<? extends T> objects) {
        mResource = resource;
        mVariableId = variableId;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ViewDataBinding binding = DataBindingUtil.inflate(inflater, mResource, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mBinding.setVariable(mVariableId, object);
