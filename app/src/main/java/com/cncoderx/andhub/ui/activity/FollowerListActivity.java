 ...
 * @author cncoderx
 */
public class FollowerListActivity extends RecyclerViewActivity
    ...
    private class PaginationFactory implements Pagination.Factory<User> {
        ...
        public Single<List<User>> create(int pageIndex, int pageSize) {
            ...
            if (TextUtils.isEmpty(user)) {
                return mService.getFollowers(pageIndex, pageSize);
            } else {
                return mService.getFollowers(user, pageIndex, pageSize);
            }
        }
    }
}
