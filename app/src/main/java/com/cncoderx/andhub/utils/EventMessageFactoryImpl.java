...
import com.cncoderx.andhub.model.EventType;
...
public class EventMessageFactoryImpl implements EventType.EventMessageFactory {
    ...
    public static void setEventType(TextView view, Event event) {
        if (event == null || event.type == null) {
            view.setText("");
        } else {
            EventType type = event.type;
            view.setText(type.getMessage(view.getContext(),
                    event, new EventMessageFactoryImpl()));
        }
    }
